        ...
        return DOM.create(`
            <div class="module-section gap-lg" style="display: flex; flex-direction: column;">
                    ...
                    <div class="panel-header flex items-center gap-md">
                        ...
                        <div style="display: flex; flex-direction: column;">
                            ...
                            <div style="display: flex; gap: 0.6rem; margin-top: 0.8rem; flex-wrap: wrap; align-items: center;">
                                <a href="mailto:daybuwaghmare@outlook.com" style="text-decoration: none; background: rgba(0,240,255,0.1); color: var(--text-primary); padding: 4px 10px; border-radius: 4px; border: 1px solid rgba(0,240,255,0.3); font-size: 0.8rem; transition: 0.3s;" onmouseover="this.style.background='rgba(0,240,255,0.2)'" onmouseout="this.style.background='rgba(0,240,255,0.1)'">📧 daybuwaghmare@outlook.com</a>
                ...
                <div style="display: flex; flex-direction: column; gap: 1rem;">
                    ...
                    <div class="panel" style="display: flex; flex-direction: column; gap: 1rem; margin-top: 1rem;">
                        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px;">
                            <div>
                                <h3 style="color: var(--text-primary); font-size: 1.2rem; margin: 0;">GitHub Live Contributions</h3>
                                <p class="text-secondary" style="font-size: 0.85rem; margin: 4px 0 0 0;">Real-time tracking of active code pushes and open source contributions</p>
                            </div>
                            <a href="https://github.com/D5BU" target="_blank" class="btn-pill" style="text-decoration: none; font-size: 10px; padding: 6px 14px; border-radius: 50px; display: inline-flex; align-items: center; gap: 6px;">
                                ...
                                <span>Follow @D5BU</span>
                            </a>
                        </div>
                        <div style="background: rgba(0, 0, 0, 0.2); border-radius: 6px; padding: 16px; overflow-x: auto; display: flex; justify-content: center; align-items: center; border: 1px solid var(--border-low-opacity);">
                            <img src="https://ghchart.rshah.org/eb5939/D5BU" alt="Shubham's GitHub Contributions Grid" style="max-width: 100%; height: auto; filter: drop-shadow(0 0 8px rgba(235, 89, 57, 0.15));" onerror="this.style.display='none';">
                        </div>
                    </div>
                </div>
